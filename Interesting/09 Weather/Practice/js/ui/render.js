...
export async function renderWeatherToday(data) {
...
export function renderWeather5days(extraInfo) {
...
function renderNearbyPlacesWeather(data) {
    if(!data) {
...
function render5daysWeather(extraInfo) {
...
export function renderHourlyWeather(data, dayNumber = null) {
